      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5" novalidate>
            <div class="relative">
              <label for="reset-password" class="sr-only">{{ t('resetPassword.password') }}</label>
              <input
                id="reset-password"
                v-model="password"
            ...
            <div class="relative">
              <label for="reset-confirm-password" class="sr-only">{{ t('resetPassword.confirmPassword') }}</label>
              <input
            ...
            >
              ...
              <span v-else class="flex items-center justify-center">
                <svg aria-hidden="true" class="animate-spin -ml-1 mr-3 h-5 w-5 text-slate-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
