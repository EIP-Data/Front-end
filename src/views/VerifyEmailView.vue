    ...
    <div class="w-full max-w-6xl px-6 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div v-if="isVerifying" role="status" aria-live="polite" class="mt-10">
            <div class="flex items-center justify-center space-x-3 mb-4">
              <svg aria-hidden="true" class="animate-spin h-8 w-8 text-amber-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div v-if="isSuccess" role="status" aria-live="polite" class="mt-10">
          ...
          <div v-if="isError" role="alert" class="mt-10">
