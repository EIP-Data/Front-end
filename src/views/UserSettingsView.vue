    ...
    <div class="flex flex-col gap-6 max-w-3xl">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="flex flex-col gap-4">
          <div>
            <p class="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
          ...
          <div>
            ...
            <div class="flex items-center gap-3">
              ...
              <span v-if="passwordResetState === 'success'" role="status" aria-live="polite" class="text-sm text-green-600 dark:text-green-400">
                {{ t('userSettings.account.resetEmailSent') }}
              </span>
              <span v-if="passwordResetState === 'error'" role="alert" class="text-sm text-red-500">
        ...
        >
          ...
          >
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 id="delete-account-modal-title" class="text-lg font-semibold text-gray-900 dark:text-white">
            ...
            <label for="delete-confirm-email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
